        ...
        <div>
            <div className='flex flex-col justify-center items-center py-5'>
                <Link href={`/releases/${release.slug}`}>
                    <img src={`${release.img}`} width={190} height={190} alt={release.title} className='brightness-90 hover:brightness-100 cursor-pointer' />
                </Link>
                ...
                <h4 className='italic text-md lg:text-lg text-black font-bold mt-3'>{release.title}</h4>
            </div>
        </div>
    )
}
